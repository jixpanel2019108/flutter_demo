...
//
//     final conteoParqueosResponseModel = conteoParqueosResponseModelFromJson(jsonString);

import 'dart:convert';

ConteoParqueosResponseModel conteoParqueosResponseModelFromJson(String str) => ConteoParqueosResponseModel.fromJson(json.decode(str));

String conteoParqueosResponseModelToJson(ConteoParqueosResponseModel data) => json.encode(data.toJson());

class ConteoParqueosResponseModel {
    ConteoParqueosResponseModel({
        this.msg,
        this.code,
        this.totalD,
        this.listado1,
    ...
    factory ConteoParqueosResponseModel.fromJson(Map<String, dynamic> json) => ConteoParqueosResponseModel(
        msg: json["msg"],
        code: json["code"],
        totalD: json["totalD"],
